...
const RecipeDetailScreen = () => {
  ...
  useEffect(() => {
    const init = async () => {
      ...
      try {
        const response = await fetch(`${API_URL}/favorites/${localUserId}`);
  ...
  if (loading || !userId) return <LoadingSpinner message="Loading recipe details..." />;
